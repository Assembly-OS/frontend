...
const ru: Dictionary = {
  ...
  "thread.deleteThreadWarn": "Чат и все записи в нём исчезнут из проекта; копия сохранится в архиве Ассамблеи. Договорённости и поручения останутся, но потеряют привязку.",
